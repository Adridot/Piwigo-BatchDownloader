...
<fieldset>
  ...
  <ul class="set-infos">
    ...
    <li><b>{'Photo sizes'|translate}:</b> {if $set.SIZE=='original'}{'Original'|translate}{else}{$set.SIZE|translate}{/if} {if isset($set.SIZE_INFO)}<span class="downloadSizeDetails">({$set.SIZE_INFO})</span>{/if}</li>
